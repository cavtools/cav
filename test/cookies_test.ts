...
Deno.test(
  ...
  () => testCookieJar({
    req: new Request("http://localhost/test", {
      ...
      headers: {
        cookie: "wholetthe=WyJ3aG9sZXR0aGUiLCJjYXRzb3V0Il0.WH7T_UfH3AoCqCU1j_QQGEEwtxILEaYoG9l3E5UhYy4",
      },
    }),
    keys: ["abc123"],
    op: cookies => {
...
Deno.test(
  ...
  () => testCookieJar({
    req: new Request("http://localhost/test", {
      // Payload: ["whowhowho", "who", 949381200000]
      headers: {
        cookie: "whowhowho=WyJ3aG93aG93aG8iLCJ3aG8iLDk0OTM4MTIwMDAwMF0.6LVSmFj-0_pknMCM-29oLx8XFCE-04-duykFq31WtY8",
      },
    }),
    keys: ["abc123"],
...
Deno.test(
  ...
  () => testCookieJar({
    ...
    req: new Request("http://localhost/test", {
      // Payload: ["a", "world"]
      headers: {
        cookie: "a=WyJhIiwid29ybGQiXQ.PIlTQhOh56MTmcX1c6SFxRzdL3vy_SmOY8ZBSDf7ZrU",
      },
    }),
    get: {
...
Deno.test(
  ...
  () => testCookieJar({
    ...
    req: new Request("http://localhost/test", {
      headers: {
        cookie: "b=WyJhIiwid29ybGQiXQ.PIlTQhOh56MTmcX1c6SFxRzdL3vy_SmOY8ZBSDf7ZrU",
      },
    }),
    get: {
...
Deno.test(
  ...
  () => testCookieJar({
    ...
    req: new Request("http://localhost/test", {
      headers: {
        cookie: "a=hello; b=WyJiIiwid29ybGQiXQ.V7l9sq0M71XIcSBWK5hW6cnDKsJR5X5aqQvJKlT0nPw",
      },
    }),
    op: async cookies => {
      cookies.set("a", "world", {
